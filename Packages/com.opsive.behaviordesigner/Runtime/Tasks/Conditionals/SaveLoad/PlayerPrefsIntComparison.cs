...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals.SaveLoadTasks
{
    ...
    /// <summary>
    /// Compares a PlayerPrefs integer value with another value.
    /// </summary>
    [Opsive.Shared.Utility.Category("Save//Load")]
    [Opsive.Shared.Utility.Description("Compares a PlayerPrefs integer value with another value.")]
    public class PlayerPrefsIntComparison : Conditional
    {
        /// <summary>
        ...
        [SerializeField] protected SharedVariable<int> m_CompareValue;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            var playerPrefsValue = PlayerPrefs.GetInt(m_Key.Value, m_DefaultValue.Value);
