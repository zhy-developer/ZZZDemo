...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals.Math
{
    ...
    [Opsive.Shared.Utility.Description("Checks if a float value is within a min/max range.")]
    public class FloatInRange : Conditional
    {
        /// <summary>
        ...
        [Tooltip("The float value to check.")]
        [SerializeField] protected SharedVariable<float> m_Value;
        [Tooltip("The minimum value of the range.")]
        [SerializeField] protected SharedVariable<float> m_Min;
        [Tooltip("The maximum value of the range.")]
        [SerializeField] protected SharedVariable<float> m_Max;
