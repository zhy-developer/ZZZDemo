...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals.IListTasks
{
    ...
    [Opsive.Shared.Utility.Description("Checks if an element is not in the list.")]
    public class IsElementNotInList : Conditional
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            var valid = listValue == null || listValue.Count == 0 || (elementValue != null && !listValue.Contains(elementValue));
