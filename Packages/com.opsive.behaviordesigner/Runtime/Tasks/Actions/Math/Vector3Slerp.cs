...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.Math
{
    ...
    [Opsive.Shared.Utility.Description("Spherically interpolates between two Vector3 values based on a t value (0 to 1).")]
    public class Vector3Slerp : Action
    {
        ...
        [Tooltip("The resulting spherically interpolated Vector3.")]
        [SerializeField] [RequireShared] protected SharedVariable<Vector3> m_Result;

        /// <summary>
        /// Spherically interpolates between the two Vector3 values.
        /// </summary>
        /// <returns>The status of the action.</returns>
        public override TaskStatus OnUpdate()
        {
            var t = Mathf.Clamp01(m_T.Value);
            m_Result.Value = Vector3.Slerp(m_From.Value, m_To.Value, t);
