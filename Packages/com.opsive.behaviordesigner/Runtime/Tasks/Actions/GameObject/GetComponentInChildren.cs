...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.GameObjectTasks
{
    ...
    [Opsive.Shared.Utility.Description("Gets a component from a GameObject's children using the string component type name.")]
    public class GetComponentInChildren : TargetGameObjectAction
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            m_StoreResult.SetValue(m_ResolvedGameObject.GetComponentInChildren(componentType));
            return TaskStatus.Success;
        }
