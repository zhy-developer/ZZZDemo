...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.GameObjectTasks
{
    ...
    [Opsive.Shared.Utility.Description("Gets a component from a GameObject using the string component type name.")]
    public class GetComponent : TargetGameObjectAction
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (componentType == null) {
                Debug.LogError($"Error: The Type {m_ComponentType} cannot be found.");
                return TaskStatus.Success;
            }
            m_StoreResult.SetValue(m_ResolvedGameObject.GetComponent(componentType));
            return TaskStatus.Success;
        }
