...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.AnimatorTasks
{
    ...
    [Opsive.Shared.Utility.Description("Plays an animation on the Animator component. Optionally waits until the animation completes.")]
    public class Play : TargetGameObjectAction
    {
        ...
        [Tooltip("The layer index to play on.")]
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (!m_HasStartedAnimation) {
                m_ResolvedAnimator.Play(m_StateName.Value, m_Layer.Value);
