...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.Conversions
{
    ...
    [Opsive.Shared.Utility.Description("Converts a Vector2 to a float value. Can extract magnitude, squared magnitude, X, or Y component.")]
    public class ConvertVector2ToFloat : Action
    {
        /// <summary>
        /// Specifies how to convert the Vector2 to a float.
        /// </summary>
        ...
        [Tooltip("Specifies how to convert the Vector2 to a float.")]
        ...
        /// <summary>
        /// Converts the Vector2 to a float based on the conversion type.
        /// </summary>
