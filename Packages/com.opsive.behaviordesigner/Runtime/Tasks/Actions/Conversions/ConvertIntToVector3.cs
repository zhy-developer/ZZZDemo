...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.Conversions
{
    ...
    [Opsive.Shared.Utility.Description("Converts an int to a Vector3 by setting X, Y, Z, or all components to the int value.")]
    public class ConvertIntToVector3 : Action
    {
        /// <summary>
        ...
        public enum SetComponent
        {
            ...
            SetAll      // Set all components (X, Y, Z) to the int value.
        }
