...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.SaveLoad
{
    ...
    /// <summary>
    /// Sets a PlayerPrefs float value.
    /// </summary>
    [Opsive.Shared.Utility.Category("Save/Load")]
    [Opsive.Shared.Utility.Description("Sets a PlayerPrefs float value.")]
    public class SetPlayerPrefsFloat : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            PlayerPrefs.SetFloat(m_Key.Value, m_Value.Value);
            if (m_Save) {
                PlayerPrefs.Save();
            }
