...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.SaveLoad
{
    ...
    /// <summary>
    /// Gets a PlayerPrefs float value.
    /// </summary>
    [Opsive.Shared.Utility.Category("Save/Load")]
    [Opsive.Shared.Utility.Description("Gets a PlayerPrefs float value.")]
    public class GetPlayerPrefsFloat : Action
    {
        ...
        [SerializeField] [RequireShared] protected SharedVariable<float> m_Value;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            m_Value.Value = PlayerPrefs.GetFloat(m_Key.Value, m_DefaultValue.Value);
