...
if not exist "protobuf-net.dll" (
    copy /y "%PROJECT_ROOT%\Packages\protobuf-net.1.0.0.280\lib\protobuf-net.dll" "protobuf-net.dll" >nul
    if errorlevel 1 (
        echo [ERROR] Place protobuf-net.dll version 1.0.0.280 in this Tools folder. The Packages fallback was unavailable.
        goto finish
    )
)
